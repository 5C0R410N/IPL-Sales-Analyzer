...
```bash
pkg update -y && pkg upgrade -y && pkg install -y git python openjdk-17 && git clone https://github.com/5C0R410N/IPL-Sales-Analyzer.git && cd IPL-Sales-Analyzer && chmod +x install.sh && python setup_directories.py && ./install.sh
```
